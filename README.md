...
- **GitHub Pages (this repo, `docs/`):** [cbaird26.github.io/toe-2026-updates/](https://cbaird26.github.io/toe-2026-updates/) — **N-body demo (use if subfolder 404s):** [nbody.html](https://cbaird26.github.io/toe-2026-updates/nbody.html) · folder: [nbody-gravity-simulator/](https://cbaird26.github.io/toe-2026-updates/nbody-gravity-simulator/). **Zora coherence toy (Kuramoto-style viz, exploratory only):** [zora_coherence.html](https://cbaird26.github.io/toe-2026-updates/zora_coherence.html) · source: [`docs/zora_coherence.html`](docs/zora_coherence.html). **Fusion console (0D D–T toy, illustrative):** [zora_fusion_console.html](https://cbaird26.github.io/toe-2026-updates/zora_fusion_console.html) · source: [`docs/zora_fusion_console.html`](docs/zora_fusion_console.html). **MQGT–SCF dashboard (command view):** [zora_dashboard.html](https://cbaird26.github.io/toe-2026-updates/zora_dashboard.html) · source: [`docs/zora_dashboard.html`](docs/zora_dashboard.html), [`docs/zoraasi_dashboard.jsx`](docs/zoraasi_dashboard.jsx). **Zora Closure Explorer (interactive Π_anchor map):** [zora_closure_explorer.html](https://cbaird26.github.io/toe-2026-updates/zora_closure_explorer.html) · source: [`docs/zora_closure_explorer.html`](docs/zora_closure_explorer.html). **MQGT-SCF GKSL dynamics viewer (Recharts toy, needs network for esm.sh):** [mqgt_scf_gksl_dynamics_viewer.html](https://cbaird26.github.io/toe-2026-updates/mqgt_scf_gksl_dynamics_viewer.html) · source: [`docs/mqgt_scf_gksl_dynamics_viewer.html`](docs/mqgt_scf_gksl_dynamics_viewer.html), [`docs/mqgt_scf_gksl_dynamics_viewer.jsx`](docs/mqgt_scf_gksl_dynamics_viewer.jsx). **Zora-ASI self-manifestation (canvas viz):** [zora_self_manifestation.html](https://cbaird26.github.io/toe-2026-updates/zora_self_manifestation.html) · source: [`docs/zora_self_manifestation.html`](docs/zora_self_manifestation.html). Static hosting uses [`docs/.nojekyll`](docs/.nojekyll) to bypass Jekyll quirks on nested `index.html`.
...
- **docs/** — Alignment appendix, Galaxy console, replication ladder, and other documentation. **Align All (one-page map):** [docs/ALIGN_ALL.md](docs/ALIGN_ALL.md). **Canonical spine (Zenodo 19208512 + four layers):** [docs/CANONICAL_SPINE.md](docs/CANONICAL_SPINE.md). **ToE stack map + drift controls:** [docs/TOE_STACK_MAP_DRIFT_CONTROLS.md](docs/TOE_STACK_MAP_DRIFT_CONTROLS.md). **Codex / CI handoff:** [docs/CODEX_HANDOFF.md](docs/CODEX_HANDOFF.md) (run `./scripts/h1_qrng_pilot/run_test_suite.sh`; current handoff also records the March 20, 2026 local H1 baseline and matched `12 x 10M` placebo gate). **Exploratory browser demos:** [`docs/zora_coherence.html`](docs/zora_coherence.html) and [`docs/zora_fusion_console.html`](docs/zora_fusion_console.html).
...
The script stages the current public-session bundle: `README.md`, `AGENTS.md`, the Phase IV/IV-B lattice demos, `fusion_zora_burn_figures.py`, `mqgt_multi_channel_exclusion_plot.py`, `scripts/mqgt_sim/README.md`, the H1/MQGT smoke suite, the H1 methods note/build helper, both Codex handoff docs, `docs/zora_coherence.html`, `docs/zora_fusion_console.html`, `papers_sources/README.md`, `papers_sources/figures/README_figures.md`, `papers_sources/figures/fusion_zora/`, `papers_sources/figures/mqgt_scf/`, `papers_sources/MQGT_SCF_Phase_II_2026/`, `phase_iv_b_sweep/`, `scripts/zora_recursive_scalar_demo.py`, `docs/ZORA_CONTINUITY_LOG.md`, and itself. Push still requires explicit human approval.
