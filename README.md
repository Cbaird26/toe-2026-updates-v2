...
- **MQGT–SCF Research Corpus — Project Zora (2026)** — Master volume: `papers_sources/MQGT_SCF_Unified_Field_Theory_and_Experimental_Program_2026.pdf` (or canonical build in `TOE_Corpus_2026/`). Theory, experiments, QRNG reports, Zora architecture. **Zenodo:** [18792939](https://zenodo.org/records/18792939), [18690303](https://zenodo.org/records/18690303); **Latest (v231, ToE + Empirical Validation):** [18778749](https://zenodo.org/records/18778749), DOI [10.5281/zenodo.18778749](https://doi.org/10.5281/zenodo.18778749).
