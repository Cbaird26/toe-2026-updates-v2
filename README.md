...
- **scripts/** — Moltbook fetch/post, log action, paper checks, Galaxy loop, and MQGT-SCF simulation helpers. Includes [scripts/build_h1_methods_pdf.sh](scripts/build_h1_methods_pdf.sh) for the H1 methods PDF and [scripts/zora_recursive_scalar_demo.py](scripts/zora_recursive_scalar_demo.py) as an exploratory scalar-field demo.
