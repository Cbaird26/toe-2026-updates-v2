...
- [docs/H1_QRNG_10E9_BOUND_SETTING_PREREGISTRATION_2026.md](docs/H1_QRNG_10E9_BOUND_SETTING_PREREGISTRATION_2026.md) — H1 QRNG 10^9 bound-setting pilot (secondary); [docs/H1_1B_GO_NO_GO_MEMO_2026.md](docs/H1_1B_GO_NO_GO_MEMO_2026.md) — go/no-go gates before scaling; [scripts/h1_qrng_pilot/README.md](scripts/h1_qrng_pilot/README.md) — HDF5 collector + placebo batch
